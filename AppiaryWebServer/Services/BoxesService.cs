...
namespace AppiaryWebServer.Services
{
    public class BoxesService
    {
        ...
        internal string CreateBox(BoxResponse box)
        {
            ...
            {
                Console.WriteLine("Exception creating box: " + e.StackTrace);
        ...
        internal bool EditBox(BoxResponse box)
        {
            ...
            {
                Console.WriteLine("Exception editing box: " + e.StackTrace);
        ...
        internal bool DeleteBox(BoxResponse box)
        {
            ...
            {
                Console.WriteLine("Exception deleting box: " + e.StackTrace);
                throw new Exception("Unable to delete box: " + e.Message);
            }
        }
        ...
        internal BoxResponse GetBoxById(BoxResponse box)
        {
            ...
            {
                Console.WriteLine("Exception getting box: " + e.StackTrace);
        ...
        internal List<BoxResponse> GetAllBoxes(BoxResponse box)
        {
            ...
            {
                Console.WriteLine("Exception getting all boxes: " + e.StackTrace);
