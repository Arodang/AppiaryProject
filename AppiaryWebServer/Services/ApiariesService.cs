...
namespace AppiaryWebServer.Services
{
    public class ApiariesService
    {
        ...
        internal string CreateApiary(ApiaryResponse apiary)
        {
            ...
            {
                Console.WriteLine("Exception creating apiary: " + e.StackTrace);
        ...
        internal bool EditApiary(ApiaryResponse apiary)
        {
            ...
            {
                Console.WriteLine("Exception editing apiary: " + e.StackTrace);
        ...
        internal bool DeleteApiary(ApiaryResponse apiary)
        {
            ...
            {
                Console.WriteLine("Exception delete apiary: " + e.StackTrace);
                throw new Exception("Unable to delete apiary: " + e.Message);
            }
        }
        ...
        internal ApiaryResponse GetApiaryById(ApiaryResponse apiary)
        {
            ...
            {
                Console.WriteLine("Exception getting apiary: " + e.StackTrace);
        ...
        internal List<ApiaryResponse> GetAllApiaries(ApiaryResponse apiary)
        {
            ...
            {
                Console.WriteLine("Exception getting all apiaries: " + e.StackTrace);
